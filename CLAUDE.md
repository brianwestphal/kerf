...
npm run check:features    # KF-284: ensures every behavior in the docs/14-feature-coverage.md index maps to a live guarding test (a behavior/transition axis orthogonal to line coverage)
