...
| Lists and menus         | `List`, `ListItem`, `ListActionRow`, `ListHeader`                                            | Stretch-aligned vertical layout with optional gap/flex/scroll/divider ownership and physical-side text/control insets; navigation/action rows, sibling primary/trailing row actions, and section headings with semantic count/countLabel pills, plus narrow typed `data-*` and popover-relationship extension slots but no domain commands                                                              |
| Horizontal layout       | `Row`                                                                                        | Horizontal flex composition with physical horizontal and vertical alignment, typed spacing, physical-side text/control insets, and opt-in wrapping; defaults to left/full alignment, the `xs` gap, and no wrapping.                                                                                                                                                                                     |
