...
| --- | --- | --- | --- |
| MenuItem/MenuHeader wrappers | gap then duplicate / P1 | `components/menu-item.tsx:26`; `menu-header.tsx:8` | KF-7CH4AV (typed root/trigger extension hooks), then HS2-HYGWCM (Hot Sheet 2 adoption). Keep domain data attributes and action/popover relationships without copying anatomy. A role=menuitem override alone must not masquerade as a complete menu. |
