...
const ENTRY_DTS = ['index.d.ts', 'array-signal.d.ts', 'jsx-runtime.d.ts', 'testing.d.ts', 'html.d.ts', 'actions.d.ts', 'overlay.d.ts', 'scope.d.ts', 'async.d.ts', 'list.d.ts', 'timing.d.ts', 'remount.d.ts'];
