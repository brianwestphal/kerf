---
title: 9 · raw() + sanitisation
description: Markdown preview. raw() injects HTML, DOMPurify guarantees it's safe.
---

import { Code } from '@astrojs/starlight/components';
import LiveExample from '../../../../components/examples/basics/09-raw-sanitise.astro';
import source from '../../../../examples/basics/09-raw-sanitise/main.tsx?raw';
