...
Chat bubbles, comment boxes, support widgets, dashboards that drop into someone else's page. The host page may already have React, jQuery, Vue, or nothing. Adding ~11 KB is reasonable; adding 200 KB is not.
