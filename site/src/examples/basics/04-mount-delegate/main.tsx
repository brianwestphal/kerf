...
mount(root, () => (
  <div class="kerf-stack">
    <p class="kerf-helper-text">
      A pretend toolbar. Each click is logged below — nothing persists or leaves
      the page.
    </p>
    ...
    <div>
      <div style="display: flex; justify-content: space-between; align-items: baseline; gap: 1rem;">
        ...
        <button class="kerf-link-button" type="button" data-action="clear-log">
          Clear log
        </button>
      </div>
      <ul
        class="kerf-output kerf-mono"
        style="list-style: none; padding-left: 1rem; min-height: 7em;"
      >
