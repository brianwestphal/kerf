      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Coming from Solid', slug: 'migrating/solid' },
            { label: 'Coming from Preact', slug: 'migrating/preact' },
            ...
            { label: 'Coming from htmx', slug: 'migrating/htmx' },
            { label: 'Coming from Angular', slug: 'migrating/angular' },
            { label: 'Coming from jQuery', slug: 'migrating/jquery' },
            { label: 'Coming from Redux', slug: 'migrating/redux' },
            { label: 'Using Kerf with Astro', slug: 'migrating/astro' },
          ],
        },
      ],
    }),
