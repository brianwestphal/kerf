...
| `router` | the postcard router: Home → Guides list → a `/guides/:slug` detail → About; the outlet swaps each page (slides up), the active nav tab follows, the URL hash updates, no reloads |
