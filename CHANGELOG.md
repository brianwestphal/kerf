...
- Added a full-site Playwright visual audit covering all 52 sitemap routes at desktop, tablet, and mobile widths, with full-page captures plus overflow, broken-image, and collapsed-content checks. Long inline API identifiers now wrap on narrow screens without changing preformatted code-block scrolling.
