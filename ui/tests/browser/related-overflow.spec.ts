...
test('the related-entries menu does not overflow the viewport when open', async ({ page }) => {
  ...
  await expect(relationships.locator('.kui-catalog__related-heading').first()).toBeVisible();
