...
const limits = {
  ...
  // Measured at 249.09 kB after adding MenuHeader count semantics and focused
  // specimens; keep only narrow headroom and preserve the Web Awesome split point.
  totalJavaScriptGzip: 249_250,
};
