...
const limits = {
  ...
  // Measured at 250.66 kB after adding the navigation-stack recipe (NavStack +
  // device-class); keep only narrow headroom and preserve the Web Awesome split.
  totalJavaScriptGzip: 251_500,
};
