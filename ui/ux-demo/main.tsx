...
import { activeTab, ADOPTION_SUGGESTIONS, adoptionOpen, adoptionQuery, adoptionReadout, adoptionTokens, bannerTone, collapsibleSearchOpen, customDisclosureOpen, disclosureOpen, displayDensity, floatingToolbarOpen, icon, inspectorSection, menuActionCurrent, menuActionPressed, menuToolsOpen, regionSize, selectedChoice, tabBarActive, tabBarTabs, tokenSearchQuery, tokenSearchTokens, toolbarChoice, toolbarFindOpen, toolbarFindQuery, toolbarGroupSearchOpen, toolbarGroupShape } from './demos/state.js';
...
let webAwesomeDemos: Record<WebAwesomeCatalogId, () => ReturnType<typeof ToolbarControlGroup>> | undefined;
