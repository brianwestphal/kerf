...
const overflowLabel = 'A very long workspace name that does not fit the available width and keeps going past two lines';
...
function ToolbarTextDemo() {
  return <div class="kui-catalog-example-stack" data-demo="toolbar-text">
    ...
    <CatalogExample label="Ellipsis (default)" note={<>One line, ellipsized when it does not fit.</>} align="none"><div class="toolbar-text-overflow-demo"><ToolbarText text={overflowLabel} size="large" /></div></CatalogExample>
    <CatalogExample label="Wrap" note={<><code>wrap</code> flows onto multiple lines instead.</>} align="none"><div class="toolbar-text-overflow-demo"><ToolbarText text={overflowLabel} size="large" wrap /></div></CatalogExample>
    <CatalogExample label="Wrap, capped to 2 lines" note={<><code>maxLines</code> caps the wrap and ellipsizes past it.</>} align="none"><div class="toolbar-text-overflow-demo"><ToolbarText text={overflowLabel} size="large" wrap maxLines={2} /></div></CatalogExample>
  </div>;
}
...
const stopActions = delegateActions(app, 'click', {
  ...
  'select-segment-demo': (_event, element) => {
    ...
    if (id === 'toolbar-group-shape' && (value === 'pill' || value === 'rounded')) toolbarGroupShape.value = value;
