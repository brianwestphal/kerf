...
export const generatedKerfCatalog = [
  ...
  },
  {
    ...
    "kind": "component",
    "source": "kerf",
    "description": "Standardize vertical component layout, optional physical-side text/control insets, and scroll/divider ownership instead of repeating ad-hoc flex-column wrappers.",
    "uses": [
      "list-header",
      "list-action-row",
      "list-item"
