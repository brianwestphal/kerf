    ...
    <div class="demo-control-stack">
      <CatalogExampleStack rootAttributes={{ 'data-demo': 'select' }}>
        <CatalogExample label="Rendering balance" align="inline-control">
          <div class="demo-example-cluster demo-control-stack__example-frame">
            <Select<string>
              ...
              renderSelected={(choice) => (
                <span class="demo-select-selected">
                  {choice.icon ? (
                    <span class="demo-select-selected__icon-frame">
                      <LucideIcon
                        icon={choice.icon}
                        name={
                          choice.iconName ??
        ...
        >
          <div class="demo-control-stack__example-frame">
            <Select<string>
