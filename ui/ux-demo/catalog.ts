...
export const webAwesomeCatalog = [
  ...
  { id: 'wa-button-group', name: 'Button Group', category: 'Actions', kind: 'component', source: 'webawesome', description: 'Visually joins related buttons into a single control group.', uses: ['wa-button'] },
  ...
  { id: 'wa-dropdown', name: 'Dropdown', category: 'Actions', kind: 'component', source: 'webawesome', description: 'Anchors a menu of actions to a trigger control.', uses: ['wa-dropdown-item', 'wa-popup'] },
  { id: 'wa-dropdown-item', name: 'Dropdown Item', category: 'Actions', kind: 'component', source: 'webawesome', description: 'An action, checkbox, or submenu row inside a dropdown.', uses: ['wa-icon'] },
  ...
  { id: 'wa-option', name: 'Option', category: 'Forms', kind: 'component', source: 'webawesome', description: 'Selectable option row used by the Select component.', uses: ['wa-icon'] },
  ...
  { id: 'wa-select', name: 'Select', category: 'Forms', kind: 'component', source: 'webawesome', description: 'Popup listbox for selecting one or more options.', uses: ['wa-icon', 'wa-popup', 'wa-tag', 'wa-option'] },
  ...
  { id: 'wa-split-panel', name: 'Split Panel', category: 'Layout', kind: 'component', source: 'webawesome', description: 'Two resizable adjacent panels separated by a draggable divider.', uses: [] },
  ...
  { id: 'wa-tab', name: 'Tab', category: 'Navigation', kind: 'component', source: 'webawesome', description: 'One selectable label in a Web Awesome tab group.', uses: [] },
  { id: 'wa-tab-group', name: 'Tab Group', category: 'Navigation', kind: 'component', source: 'webawesome', description: 'Associates selectable tabs with named content panels.', uses: ['wa-button', 'wa-tab', 'wa-tab-panel'] },
  { id: 'wa-tab-panel', name: 'Tab Panel', category: 'Navigation', kind: 'component', source: 'webawesome', description: 'Named content region controlled by a tab.', uses: [] },
  { id: 'wa-tree', name: 'Tree', category: 'Navigation', kind: 'component', source: 'webawesome', description: 'Hierarchical navigation with selection and expansion.', uses: ['wa-tree-item'] },
  { id: 'wa-tree-item', name: 'Tree Item', category: 'Navigation', kind: 'component', source: 'webawesome', description: 'Selectable, nestable row inside a tree.', uses: ['wa-checkbox', 'wa-icon', 'wa-spinner'] },
  ...
  { id: 'wa-animated-image', name: 'Animated Image', category: 'Media', kind: 'component', source: 'webawesome', description: 'Animated image with an accessible play and pause control.', uses: ['wa-icon'] },
  ...
  { id: 'wa-comparison', name: 'Comparison', category: 'Media', kind: 'component', source: 'webawesome', description: 'Draggable before-and-after media comparison.', uses: ['wa-icon'] },
  { id: 'wa-icon', name: 'Icon', category: 'Media', kind: 'component', source: 'webawesome', description: 'Icon renderer backed by registered Web Awesome libraries.', uses: [] },
  ...
  { id: 'wa-popup', name: 'Popup', category: 'Helpers', kind: 'component', source: 'webawesome', description: 'Low-level anchored positioning primitive.', uses: [] },
...
export const kerfCatalog = [
  ...
  { id: 'toolbar-control-group', name: 'ToolbarControlGroup', category: 'Structure', kind: 'component', source: 'kerf', description: 'Contained, borderless, pressed, and single-control toolbar groups.', uses: ['lucide-icon'] },
