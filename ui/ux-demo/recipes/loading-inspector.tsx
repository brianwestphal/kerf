...
export const createRecipe: RecipeFactory = (announce) => {
  ...
  const render = () => {
    ...
    return (
      <RecipeRoot
        recipe="recipe-loading-inspector"
        measure="inspector"
        dataAttributes={{ 'data-inspector-loading': String(p) }}
      >
        <div class="recipe-inspector">
          <Pane
            ...
            header={
              <>
                ...
                />
                <RecipeHeadingSummary id="recipe-inspector-summary">
                  {p ? (
          ...
          >
            ...
            <RecipeOwnershipNote>
              Each value-bearing component's <code>placeholder</code> prop
              renders skeletons in its value slots while loading, so the recipe
              composes a faithful loading inspector from real chrome. The app
              owns the loading lifecycle and which values are still unknown.
            </RecipeOwnershipNote>
          </Pane>
        </div>
      </RecipeRoot>
