...
const specimenRenderers: Record<WebAwesomeCatalogId, DemoRenderer> = {
  ...
  'wa-badge': () => <div class="wa-demo-labeled-stack"><span>Status badges · pill</span><div class="wa-demo-row"><wa-badge variant="neutral" pill="pill">Draft</wa-badge><wa-badge variant="brand" pill="pill">In review</wa-badge><wa-badge variant="success" pill="pill">Ready</wa-badge><wa-badge variant="warning" pill="pill">Attention</wa-badge><wa-badge variant="danger" pill="pill">Blocked</wa-badge></div></div>,
  ...
  'wa-tag': () => <div class="wa-demo-labeled-stack"><span>Tags · rounded rectangle</span><div class="wa-demo-row"><wa-tag variant="neutral">frontend</wa-tag><wa-tag variant="brand">design-system</wa-tag><wa-tag variant="success">stable</wa-tag><wa-tag variant="warning" with-remove="with-remove">needs-review</wa-tag></div><small>Removal is owned by the feature handling the bubbling <code>wa-remove</code> event.</small></div>,
  ...
  'wa-tooltip': () => <div class="wa-demo-labeled-stack"><span>Kerf default · no arrow</span><div class="wa-demo-row"><wa-button id="catalog-tooltip-target" appearance="outlined">Hover or focus</wa-button><wa-tooltip for="catalog-tooltip-target">Uses the shared tooltip palette</wa-tooltip></div><small>Override <code>--wa-tooltip-arrow-size</code> or add <code>without-arrow</code> explicitly when local intent should be self-documenting.</small></div>,
  ...
  'wa-popover': () => <div class="wa-demo-anchor"><span>Kerf default · no arrow</span><wa-button id="catalog-popover-target" appearance="outlined">Toggle popover</wa-button><wa-popover for="catalog-popover-target" placement="bottom"><strong>Popover content</strong><p>Interactive content stays anchored to its trigger.</p><wa-button size="small">Action</wa-button></wa-popover><small>Override <code>--kui-wa-popover-arrow-size</code> for a scope or <code>--arrow-size</code> on one popover to restore a pointer.</small></div>,
